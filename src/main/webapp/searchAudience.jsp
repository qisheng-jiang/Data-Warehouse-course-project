...
<head>
    <title>Search According to Audience</title>
...
<div class="pusher">
    <div class="mainWrap navslide">
        <div class="ui equal width left aligned padded grid stackable">
            ...
            <h3 class="ui header">Audience Search</h3>
            <div class="row">
                <div class="sixteen wide column">
                    <div class="ui segments">
                        <div class="ui segment">
                            <h4 class="ui dividing header">Audience Name</h4>
                            <form class="ui form" method="post" action="audienceSearch">
                                <div class="field">
                                    <label>Audience</label>
                                    <input type="text" name="profilename" placeholder="Full Name" style="width: 50%">
                                </div>
                                <div class="field">
                                    <label>Attitude</label>
                                    <div class="ui selection dropdown">
                                        <input type="hidden" name="emotion">
                                        <div class="default text">Attitude</div>
                                        <i class="dropdown icon"></i>
                                        <div class="menu">
                                            <div class="item" data-value="0">Negative</div>
                                ...
                                <div class="field">
                                    ...
                                    <div class="ui selection dropdown">
                                        ...
                                        <div class="default text">Score</div>
                                        <i class="dropdown icon"></i>
                                        <div class="menu">
                                            <div class="item" data-value="0">Score 5 points and above</div>
                                            <div class="item" data-value="1">Score 4 points and above</div>
                                            <div class="item" data-value="2">Score 3 points and above</div>
                                            <div class="item" data-value="3">Score 2 points and above</div>
                                            <div class="item" data-value="4">Score 4 points and below</div>
                                            <div class="item" data-value="5">Score 3 points and below</div>
                                            <div class="item" data-value="6">Score 2 points and below</div>
                                            <div class="item" data-value="7">Score 1 points and below</div>
                                        </div>
                                    </div>
                                </div>
